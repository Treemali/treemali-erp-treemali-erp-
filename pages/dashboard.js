...
async function loadKPIs() {
  ...
  try {
    ...
    const [vendasHojeRes, vendasMesRes, condicionaisRes, despesasPagarRes, crediarioReceberRes, despSimplesRes,
      ...
      window._supabase.from('saidas_nao_comerciais').select('custo_total').eq('lancou_despesa', false).gte('data', startOfMonthStr).lte('data', endOfMonthStr),
      ...
      window._supabase.from('saidas_nao_comerciais').select('custo_total').eq('lancou_despesa', false),
