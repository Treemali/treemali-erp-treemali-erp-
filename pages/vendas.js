...
function prepararPayloadVenda() {
  return {
    ...
    crediario: _estado.tipo === 'crediario' ? {
      parcelas: parseInt(document.getElementById('vendaParcelasCrediario').value) || 2,
...
function mostrarComprovante(venda, itens, clienteId) {
  ...
  const nParcelasCrediario = parseInt(document.getElementById('vendaParcelasCrediario')?.value) || 2;
