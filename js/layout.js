...
// Injeta CSS de privacidade uma vez
(function injetarCSSPrivacidade() {
  if (document.getElementById('css-privacidade')) return;
  const style = document.createElement('style');
  style.id = 'css-privacidade';
  style.textContent = `
    /* Modo privacidade — ativado pela classe no body */
    body.valores-ocultos .kpi-value,
    body.valores-ocultos .kpi-sub,
    body.valores-ocultos .fkpi-value,
    body.valores-ocultos .ckpi-value,
    body.valores-ocultos .ekpi-value,
    body.valores-ocultos .skpi-value,
    body.valores-ocultos .cpkpi-value,
    body.valores-ocultos .crkpi-value,
    body.valores-ocultos .akpi-value,
    body.valores-ocultos .hv-kpi-value,
    body.valores-ocultos .dist-valor,
    body.valores-ocultos .resultado-row strong,
    body.valores-ocultos .fin-card-value,
    body.valores-ocultos td strong,
    body.valores-ocultos .badge-success:not(.status-badge),
    body.valores-ocultos #comprovante {
      filter: blur(6px);
      user-select: none;
      transition: filter 0.2s;
    }
    body.valores-ocultos .kpi-value:hover,
    body.valores-ocultos .dist-valor:hover {
      filter: blur(0px);
    }
    /* Dados de clientes / fornecedores / contatos */
    body.valores-ocultos td:first-child strong,
    body.valores-ocultos td:first-child,
    body.valores-ocultos .cliente-nome,
    body.valores-ocultos .fornecedor-nome {
      filter: blur(5px);
      user-select: none;
    }
  `;
...
function aplicarOcultarValores(ocultar) {
  ...
  // Mascara também valores em texto (R$) para o que não é coberto pelo CSS
  if (ocultar) {
    mascararValores();
  } else {
    desmascarar();
...
function mascararValores() {
  document.querySelectorAll('*:not(script):not(style):not(input):not(select):not(textarea)').forEach(el => {
...
// Re-aplica máscara após renders dinâmicos
